...
bool Ucheck(CELL_1** board, int p1, int p2, int q1, int q2) {
    if (((p1 == q1) && (p1 == 0 || p1 == BOARDHEIGHT1 - 1) || ((p2 == q2) && (p2 == 0 || q2 == BOARDWIDTH1 - 1)))) {
        return true;
    }
    bool c1, c2, c3;
    int x, y;
...
bool checkValidPairs(CELL_1** board) {
    ...
    while (check >= 'A' && check <= 'Z') {
        int cnt = 0;
        int* pos = new int[BOARDHEIGHT1 * BOARDWIDTH1];
        for (int i = 0; i < BOARDHEIGHT1; i++) {
...
bool Ucheck2(CELL_1** board, int p1, int p2, int q1, int q2) {
    if (((p1 == q1) && (p1 == 0 || p1 == BOARDHEIGHT2 - 1) || ((p2 == q2) && (p2 == 0 || q2 == BOARDWIDTH2 - 1)))) {
        return true;
    }
    bool c1, c2, c3;
    int x, y;
...
bool allcheck2(CELL_1** board, int p1, int p2, int q1, int q2) {
    if (nextcheck(board, p1, p2, q1, q2)) {
        return true;
    }
    else if (Icheck_1(board, p1, p2, q1, q2)) {
    ...
    else if (Ucheck2(board, p1, p2, q1, q2)) {
        return true;
    }
    return false;
}
bool checkValidPairs2(CELL_1** board) {
    char check = 'A';
    while (check >= 'A' && check <= 'Z') {
        int cnt = 0;
        int* pos = new int[BOARDHEIGHT2 * BOARDWIDTH2];
        for (int i = 0; i < BOARDHEIGHT2; i++) {
        ...
        for (int i = 0; i < cnt - 2; i += 2) {
            for (int j = i + 2; j < cnt; j += 2) {
                if (allcheck2(board, pos[i], pos[i + 1], pos[j], pos[j + 1])) {
